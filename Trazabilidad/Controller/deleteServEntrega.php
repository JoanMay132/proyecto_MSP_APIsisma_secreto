<?php @session_start();
    ...
    $pkservent =(int) base64_decode($_POST['id']);
    $pkservent = filter_var($pkservent,FILTER_VALIDATE_INT);
    ...
    $rol->getPermissionControl($_SESSION['controles'],Controls::entregas->value,base64_decode(@$_POST['branch']));
