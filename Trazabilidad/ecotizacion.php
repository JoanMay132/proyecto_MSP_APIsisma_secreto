<?php @session_start(); {$title = '- ALTA COTIZACIÓN';} //TITULO DE LA PAGINA
 ...
 //Recibe el id del la cotizacion
 $idCotizacion = (int) base64_decode($_GET['edit']);
...
<script>
    ...
    function Subcotizacion(URL){
        ...
        let arriba = Math.round((ventanaAlto - 700) / 2); 
         window["SUBCOTIZACION"] ? window["SUBCOTIZACION"].focus() : window.open(URL,"SUBCOTIZACION","width=1090,height=700,scrollbars=yes,left="+izquierda+",top="+arriba+",addressbar=0,menubar=0,toolbar=0" );
    }
...
<style>
  ...
  <center><div class="loader"><h3>Cargando cotización...</h3></div></center>
    <!-- ! Main -->
    <main class="main users chart-page" id="skip-target" style="padding:15px;margin-left:0;margin-right:0;margin-bottom:0px">
    
    <form id="form-cotizacion" onsubmit="return addCotizacion();">
        <!-- INCIO DE LA PRIMERA FILA -->
        <input type="hidden" name="pkcotizacion" value="<?php echo base64_encode($resCot['pkcotizacion']); ?>">
        <div class="row">
               <label class="txt-11 text-secondary col-2 col-sm-1">FOLIO</label>
               <div class="txt-12 col-2 col-sm-1" style="padding:5px;display:flex"><p id="displayFolio" style="color:red;"><?php echo $resCot['folio']; ?></p></div>
               <input type="hidden" id="folio" name="folio" value="<?php echo $resCot['folio'] ?>">

               <label for="sucursal" class="txt-11 text-secondary col-3 col-sm-1">SUCURSAL</label>
               <select  name="sucursal" id="sucursal"  class="form-control col-3 col-sm-2" >
               <option selected value="<?php echo base64_encode($resCot['fksucursal']); ?>" ><?php echo $resCot['nombre'] ?></option>
                ...
                <input type="date" name="fecha" id="fecha" required class="form-control  col-12 col-sm-2" value="<?php echo $resCot['fecha'] ?>"  >

                <label for="listRevision" class="txt-11 text-secondary col-2 col-sm-1">REVISIÓN</label>
                <select name="revision" class="form-control col-sm-2" id="listRevision"></select>
        ...
        <div class="row" >
            ...
            <div class="col-12 col-sm-4">
                <div class="form-group row" >
                    ...
                    <select name="cliente" id="listClientes" required class="form-control txt-11 col-12 col-sm-9 " onchange="return usercustomer(this.value);" >
                        <option value=""></option>
                    </select>
                </div>
                <div class="form-group row" >
                    <label for="listUsercustomer" class="txt-11 text-secondary col-12 col-sm-3">SOLICITO:</label>
                    <select name="solicito" class="form-control col-8 col-sm-8 listUsercustomer" data-id="solicito" id="listUser">
                            <option value=""></option>
                    </select>
                ...
                <div class="form-group row">
                    ...
                    <select name="attn" onchange="return viewDepto(this.value);" class="form-control col-9 col-sm-9 listUsercustomer" id="attn">
                            <option value=""></option>
                    </select>
                </div>
                <div class="form-group row">
                    <label for="titulo" class="txt-11 text-secondary col-12 col-sm-3">TITULO:</label>
                    <input type="text" name="titulo" id="titulo" value="<?php echo htmlspecialchars($resCot['titulo']); ?>" class="form-control form-control-sm col-12 col-sm-9">
                </div>
                ...
                <div class="form-group row">
                    ...
                    <select name="vigencia" class="form-control col-8 col-sm-8" id="vigencia">
                            ...
                            <?php for($i= 2 ; $i <= 30; $i++){
                                ...
                                echo "<option value='".$i." DIAS' ".$selVigencia." >".$i." DIAS</option>";
                            } ?>
                    </select>
                </div>
                <div class="form-group row">
                    <label for="ocompra" class="txt-11 text-secondary col-12 col-sm-4">ORDEN COMP:</label>
                    <input type="text" name="ocompra" id="ocompra" value="<?php echo $resCot['ocompra'] ?>" class="form-control col-12 col-sm-8 ">
                </div>
            ...
            <!-- FIN DE LA SEGUDA COLUMNA
                ...
                <div class="form-group row" >
                        ...
                        <input type="text" name="credito" id="credito" value="<?php echo $resCot['dcredito']; ?>" class="form-control col-12 col-sm-8">
                    </div>
                    <div class="form-group row">
                        <label for="tentrega" class="txt-11 text-secondary col-12 col-sm-4">T. ENTREGA</label>
                        <input type="text" name="tentrega" id="tentrega" value="<?php echo $resCot['tiempoent']; ?>"  class="form-control col-12 col-sm-8 " >
                    </div>
        ...
        <div class="row" >
            ...
            <div class="col-12 col-sm-4">
                <div class="form-group row">
                    ...
                    <input type="text" name="lab" id="lab" value="<?php echo $resCot['lab'] ?>" class="form-control col-12 col-sm-9" >
                </div>
                <div class="form-group row">
                    <label for="garantia" class="txt-11 text-secondary col-12 col-sm-3">GARANTIA:</label>
                    <input type="text" name="garantia" id="garantia" value="<?php echo $resCot['garantia'] ?>" class="form-control col-12 col-sm-9">

                    
                </div>
                <div class="form-group row">
                <label for="costo" class="txt-11 text-secondary col-12 col-sm-3">COSTO:</label>
               <input type="text" name="fcosto"  id="costo" value="<?php echo $resCot['costo']; ?>" class="form-control col-12 col-sm-9" >
                </div>
                
                <div class="form-group row">
                <label for="area" class="txt-11 text-secondary col-12 col-sm-3">AREA:</label>
               <select  name="area" id="area"  class="form-control col-12 col-sm-8" required>
                            <option value=""></option>        
                </select>
                ...
                <div class="form-group row">
                    ...
                    <input type="text" name="cargo" id="deptouser" value="<?php echo $resCot['cargo'] ?>" class="form-control col-8 col-sm-9 ">
                </div>
            </div>
            <!-- Fin de la primer columna
                Inicio de la segunda columna -->
            <div class="col-12 col-sm-4">
                <!-- <div class="form-group row" >
                    ...
                    <textarea name="datnormativos" id="datnormativos"  class="form-control col-12 col-sm-8" style="height:35px"><?php echo $resCot['dnormativos'] ?></textarea>
                </div> -->
                <div class="form-group row" style="padding:2px;margin-top:-26px">
                    ...
                    <textarea id="fabricacion" name="fabricacion" class="form-control col-12 col-sm-8 scrollHidden" style="height:35px" onfocus="mostrarScroll('fabricacion')" onblur="ocultarScroll('fabricacion')"><?php echo $resCot['efabricacion']; ?></textarea>
                </div>
                <div class="form-group row" style="padding:2px;margin-top:-26px">
            ...
            <div class="col-12 col-sm-4" style="margin-top:-19px">
                <!-- <div class="form-group row" style="padding:2px;">
                    ...
                    <textarea id="dattecnicos" name="dattecnicos" class="form-control col-12 col-sm-8" style="padding:3px;height:35px" onfocus="mostrarScroll('dattecnicos')" onblur="ocultarScroll('dattecnicos')" ><?php echo $resCot['dattecnicos']; ?></textarea>
                 
                </div> -->
                <div class="form-group row" style="padding:2px;margin-top:-26px">
                    <label for="doclegal" class="txt-11 text-secondary col-12 col-sm-4">DOCUMENTACIÓN LEGAL:</label>
                    <textarea id="doclegal" name="doclegal" class="form-control col-12 col-sm-8" style="height:35px" onfocus="mostrarScroll('doclegal')" onblur="ocultarScroll('doclegal')"><?php echo $resCot['doclegal']; ?></textarea>

                    
                </div>
                <div class="form-group row" style="padding:2px;margin-top:-26px">
                    <label for="factura1" class="txt-11 text-secondary col-12 col-sm-4">FACTURA:</label>
                    <input type="text" name="factura1" id="factura1" value="<?php echo $resCot['factura']; ?>" class="form-control col-12 col-sm-8 "  >
                </div>
        ...
        <div class="row" >
            <div class="col-12" style="padding:2px">
                <div style="overflow:auto;height: 41vh;background:white;border:2px solid grey" class="scroll table-responsive">
                    ...
                    <table id="table" class="table-stripped table-bordered table-cotizacion" width="110%"  style="background-color: white;font-size:11px;">
                        <thead style="position: sticky;top:0;z-index: 10;" class="table-info" >
                          <tr ondblclick='addServcot(<?php echo json_encode($data); ?>,"<?php echo $viewCosto; ?>",<?php echo json_encode($tipo); ?>)'>
                            <th width="5%">PDA</th>
                            <th width="5%">CANT.</th>
                        ...
                        <tbody class="body-table" id="serv-cotizacion">
                            <?php $contador = 0;
                        ...
                        <!-- INICO DE LOS NUEVOS REGISTROS -->
                          <tr style="max-height: 80px;" ondblclick='addServcot(<?php echo json_encode($data); ?>,"<?php echo $viewCosto; ?>",<?php echo json_encode($tipo); ?>)' id="serv-0">
                            ...
                            <td valign="top"><input type="number" name="cant[]" id="cantidadNew-0" onblur="Subtotal(this); totales();" min="0.00" class="form-control form-control-sm" data-pre="cantidad" autocomplete="off"></td>
                            <td valign="top">
                                <select name="unidad[]" class="form-control form-control-sm">
                                    <option value=""></option>
                                    <?php foreach($data as $unidad){
        ...
        <div class="row">
            <div class="col-12 col-sm-2" id="displaySubcotizacion">
                <div class="subcotizacion">
                <div class="cont-border subcotizacion-add" style="overflow:auto;max-height: 100px;">
                    <?php  $enum = 0;//Enumerable para la lista
                            $totalSubcotizacion = 0;
                        foreach ($oSubcot->ListAll($resCot['pkcotizacion']) as $resub) {
                            $enum++;

                            $totalSubcotizacion += (float) $resub['total'];
                           
                            ?>
                            
                    <div class="form-inline">
                        <a onclick="javascript:Subcotizacion('subcotizacion?cot=<?php echo base64_encode($resub['pksubcotizacion']); ?>')"   id="buttonSubcot" title="Agregar subcotizacion" class="btn btn-dark"  style="width:14px;height:14px;position:relative;padding:0px;border-radius:0px;font-size:10px;color:white"><?php echo $enum; ?></a>
                        <input type="text" ondblclick="addFilaSubcotizacion('<?php echo $oSubcot->numrow; ?>');" onchange="setName(this.value,'<?php echo base64_encode($resub['pksubcotizacion']); ?>','<?php echo base64_encode($resub['fksucursal']); ?>')" name="sub[]" class="form-control form-control-sm txt-11" style="height:20px;font-size:11px;padding:2px;width:50px;" value="<?php echo $resub['nombre']; ?>">
                        <div class="price text-right" style="width:65px;background:white"><p class="txt-11 <?php echo $viewCosto; ?>" style="margin-top:3px">$<?php echo number_format($resub['total'],2,".",","); ?></p></div>
                    </div>

                    <?php  } if($enum == 0){ ?>

                    <div class="form-inline">
                        <button type="button" onclick="addSubcotizacion(true,'<?php echo $enum; ?>');"  id="buttonSubcot" title="Agregar subcotizacion" class="btn btn-dark"  style="width:14px;height:14px;position:relative;padding:0px;border-radius:0px;font-size:10px"><span style="position:absolute;left:0px;right:0px;bottom:0px;top:0px;margin:0 auto;font-size:13px;color:white;" class="fa fa-plus"></span></button>
                        <input type="text" ondblclick="addFilaSubcotizacion('<?php echo $enum; ?>');" name="sub[]" class="form-control form-control-sm txt-11" style="height:20px;font-size:11px;padding:2px;width:50px;">
                ...
                <div class="form-inline float-right">
                        ...
                        <div class="price text-right" style="background:white"><p class="txt-11 <?php echo $viewCosto; ?>" id="totalSubcotizacion" style="margin-top: 3px">$<?php echo number_format($totalSubcotizacion,2,".",","); ?></p></div>
                    </div>
                <div class="form-inline float-right">
                    <?php
                        $dif = ($totalSubcotizacion - $resCot['total']);
                    ?>
                    <div class="text-right"><p class="txt-11" style="font-weight:bold;color:darkblue">DIFERENCIA:</p></div>
                    <div class="price text-right" style="background:white"><p style="margin-top: 3px;" id="diferencia" class="txt-11 <?php echo $viewCosto; ?>">$<?php echo number_format($dif,2,".",",");  ?></p></div>
                </div>
                </div>
                ...
                <div class="row" >
                    <div class="col-12 col-sm-4">
                        <div class="form-group row">
                            ...
                            <input type="text" autocomplete="off" name="factura2" value="<?php echo $resCot['factura2']; ?>" id="factura2" class="form-control col-12 col-sm-7">
                        </div>
                        <div class="form-group row" >
                            <label for="ffactura" class="txt-11 text-secondary col-12 col-sm-7">FECHA FACTURA</label>
                            <input type="date" autocomplete="none" name="ffactura" value="<?php echo $resCot['fechafactura']; ?>" id="ffactura" class="form-control  col-12 col-sm-5" >
                        </div><hr>
                    </div>
                    <div class="col-12 col-sm-5" style="margin-top: -5px;">
                        
                            <label for="observaciones" class="txt-11 text-secondary ">OBSERVACIONES</label>
                            <textarea class="form-control form-control-sm col-12 scrollHidden" id="observaciones" name="observaciones" onfocus="mostrarScroll(this.id)" onblur="ocultarScroll(this.id)" style="margin-top:-10px" rows="3"><?php echo $resCot['observacion']; ?></textarea><br>
                            ...
                            <div class="row">
                                ...
                                <?php }else{?>
                                    <div class="col-6" style="padding:0px">
                                    <button type="button"  class="btn btn-sm btn-outline-success" onclick="return Print('<?php echo base64_encode($resCot['pkcotizacion']); ?>',false,'cotizacion','print_cotizacion');" style="white-space:normal;word-wrap:break-word" ><span class="fa fa-print"></span> IMP. COTIZACION SIN IVA</button>
                                </div>
                                
                                <div class="col-6" style="padding:0px">
                                    <button type="button" class="btn btn-sm btn-outline-warning" onclick="return Print('<?php echo base64_encode($resCot['pkcotizacion']); ?>',true,'cotizacion','print_cotizacion');"style="word-wrap:break-word"><span class="fa fa-print"></span> IMP. COTIZACION</button>
                                </div>
                                <?php } ?>
                            </div>
                    ...
                    <div class="col-12 col-sm-2" style="padding:0px;margin-top: -5px;">
                        <div class="form-group">
                                ...
                                <input type="text" autocomplete="off" name="cnacional" id="cnacional" class="form-control <?php echo $viewCosto; ?>" style="margin-top:-10px" value="$<?php echo number_format($resCot['contenido'],2,".",","); ?>">

                                <label for="pcns" class="txt-11 text-secondary">PCNS</label><br>
                                <input type="number" step="0.001" autocomplete="off" name="pcns" id="pcns" class="form-control" style="margin-top:-10px" value="0">

                                <label for="pcns" class="txt-11 text-secondary">MONEDA:</label><br>
                                <select name="tmoneda" id="tagmoneda" onchange="Cambio();"  class="form-control" style="margin-top:-10px">
                                ...
                                <input type="number" step="0.0001" onchange="totales();" autocomplete="off" name="tcambio" id="cambio" value="<?php echo $resCot['tipocambio']; ?>" class="form-control dolar" style="margin-top:-15px;display:none">
...
<script>
    $(async function () {
        ...
        let usercus = document.getElementById('attn');
        let user = document.getElementById('listUser');
        let depto = document.getElementById('area');
        ...
        await usercustomer("<?php echo base64_encode($resCot['fkcliente']); ?>");

        usercus.value = '<?php echo base64_encode($resCot['fkattnusercli']); ?>';
        user.value = '<?php echo base64_encode($resCot['fkusercli']); ?>';
        depto.value = '<?php echo base64_encode($resCot['fkdeptocli']); ?>';

         Add('<?php echo base64_encode($resCot['fkcliente']); ?>');
