        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-4" >
                ...
                <div class="form-group row">
                    ...
                    <div class="txt-12 col-3 col-sm-3" style="padding:5px;display:flex;"><p id="displayFolio" style="color:blue;border: 1px solid grey;padding:2px;font-weight:bold"><?php echo $resOt['folio']; ?></p>
                    </div>
            ...
            <div class="col-12" style="padding:2px">
                ...
                <table id="table" class="table-bordered table-ot" width="100%"  style="background-color: white;font-size:11px; border-collapse:collapse;">
                        ...
                        <tbody class="body-table" id="serv-ot">
                            <?php $cont= 0; foreach($oOrden->GetDataAllServ($resOt['pkorden']) as $rowServ){  ?>
                          ...
                          <tr style="max-height: 80px;" ondblclick='addServot(<?php echo json_encode($data); ?>,<?php echo json_encode($tipo); ?>)'>
                            ...
                            <td valign="top"><input type="number" name="cant[]"  min="0.00" step="0.01" class="form-control form-control-sm"  autocomplete="off" value="<?php echo $rowServ['cantidad'] ?>"></td>
                            <td valign="top">
                            ...
                            <td valign="top"><textarea id="" name="dibujo[]" class="form-control cajas-texto scrollHidden" autocomplete="off" oninput="autoResize(this);" spellcheck="false" style="resize:none;height:auto;"><?php echo $rowServ['dibujo'] ?></textarea></td>
                        ...
                        <tr style="max-height: 80px;" ondblclick='addServot(<?php echo json_encode($data); ?>,<?php echo json_encode($tipo); ?>)' id="serv-0">
                            ...
                            <td valign="top"><textarea id="" name="dibujo[]" class="form-control cajas-texto scrollHidden" autocomplete="off" oninput="autoResize(this);" spellcheck="false" style="resize:none;height:30px;"></textarea></td>
