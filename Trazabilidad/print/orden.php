...
<body>
    ...
    <main>
        <table class="table-header-title" style="border:unset;table-layout: fixed;">
            <?php foreach($oOrden->Servprint($resp['pkorden']) as $result) { ?>
                <tr>
                    ...
                    <td valign="top" style="width: 71%;border: 0.6px solid #BFBFBF"><?php echo nl2br( $result['descripcion']); ?></td>
                    <td valign="top" style="width: 10.2%;text-align:left;word-wrap: break-word;border: 0.6px solid #BFBFBF"><?= nl2br($result['dibujo']); ?></td>
                </tr>
            <?php } ?>
