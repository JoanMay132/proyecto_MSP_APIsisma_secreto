...
<body>
    ...
    <header>
        ...
        <table class="table-header" style="border-collapse:collapse;font-size: 9pt;">
            ...
            <tr>
                <td class="header-subtext" colspan="4"><?php echo substr("35 D No. 84 COL. SAN AGUSTIN DEL PALMAR CIUDAD DEL CARMEN, CARMEN, CAMPECHE, MEX CP 24110",0,85); ?></td>
            </tr>
        </table>
        <!-- Fin de encabezado -->
