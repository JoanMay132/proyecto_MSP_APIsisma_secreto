<?php @session_start(); {$title = "- ENCABEZADOS";}
...
<div class="main-wrapper">
  ...
  <main class="main users chart-page">
    <div class="container">
      ...
      <h5 class="h5">ENCABEZADOS</h5>
      <hr>
      <div class="row">
        <div class="col-2">
          <?php //if($modifica){ ?>
          <a href="addencabezado?suc=<?php echo @$_GET['suc']; ?>" style="border-radius:0px;height:auto" class="btn btn-primary txt-12"><i class="fa fa-plus"></i>Nuevo</a>
          <?php //} ?>
        </div>
        <div class="col-3">
