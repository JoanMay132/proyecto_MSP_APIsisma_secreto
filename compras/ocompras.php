<?php @session_start(); {$title = '- ORDENES DE COMPRAS';} //TITULO DE LA PAGINA
  include '../dependencias/php/head.php';
  include '../controlador/Sucursal.php';
  include '../controlador/Ocompra.php';
  ...
  <div class="main-wrapper">
    ...
    <main class="main users chart-page" id="skip-target" style="padding:15px;margin-left:0;margin-right:0">
        ...
        <div class="row" style="margin-top:-10px;">
            ...
            <div class="form-group col-12 col-sm-2 text-center" style="margin-top:-10px">
                <label class="txt-12 text-secondary">Proveedor</label>
        ...
        <div class="row" style="margin-top:-15px;">
            <div class="col-12">
                <div style="overflow-y:auto;height: 83vh;margin-bottom:-58px;background:white;border:1px solid grey;" id="display-ocompra" class="contenido">
                    <table class="table-stripped table-hover display-table"  width="100%" id="table" style="font-size:11px;border-collapse: collapse;table-layout: fixed;min-width:800px">
                        ...
                        <tbody class="body-table" id="orden">
                          ...
                          <tr style="font-weight:500" onclick="return sel(this);" ondblclick="javascript:ocompras('eocompra?edit=<?php echo base64_encode($result['pkocompra']); ?>','E-OCOMPRA')" >
                            ...
                            <td id="f-cotizacion" style="border-right:1px solid #DFDFDF"><p id="folio" style="margin-left:3px;padding:3px"><?php echo $result["name_proveedor"]; ?></p></td>
                            <td id="f-cliente" style="border-right:1px solid #DFDFDF"><p style="margin-left:3px"><?php echo $result["estado"]; ?></p></td>
                          </tr>
                            <?php }?>
                        </tbody>
                    </table>
...
<script>
  function filtro(data,columna){
    ...
    function ocompras(URL,name = ""){ 

        let izquierda =Math.round((screen.width - 1050) / 2);
        let arriba = Math.round((screen.height - 600) / 2);
        window[name] ? window[name].focus() : window.open(URL,name,"width=1050,height=600,scrollbars=yes,left="+izquierda+",top="+arriba+",addressbar=0,menubar=0,toolbar=0" );
...
//     location.href = "ocompras?suc="+sucursal;
//   });
