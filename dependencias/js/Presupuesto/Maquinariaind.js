...
function CambioSucursal(data)
{
    ...
    location.href = "maquinariaind?suc="+sucursal;
}
        ...
        $("#delete").on("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        data: {"maq":maq,"branch":branch,"industrial":true},
...
function addMat(nombre,origen,costo,ventana,data,unidad = 0)
{
    var fila = '<tr>'+
                    ...
                    '<td><input type="number" name="cantidadMaquin[]" onchange="ImporteMaquinaria(this);" class="form-control form-control-sm no-bg input-form border-dark text-center" min="0" value="0" step="0.01" style="height: 20px;" ></td>'+
                    '<td>'+
