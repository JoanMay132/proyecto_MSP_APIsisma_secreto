...
function addMateriales_v2(data)
{
	...
	$.ajax({
		type: "POST",
		data: {"material":descMaterial,"origen":origen,"unidad":unidad,"precio":precio,"sucursal":sucursal,"id":id},
		dataType: "json",
...
function CambioSucursal(data)
{
    ...
    location.href = "materiales?suc="+sucursal;
}
        ...
        $("#delete").on("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        data: {"pkmaterial":mat,"branch" : branch},
...
function addMat(nombre,origen,unidad,costo,ventana,data)
{
    var fila = '<tr>'+
                    ...
                    '<td><input type="number" name="cantidad[]" onchange="Importe(this);" class="form-control form-control-sm no-bg input-form border-dark text-center" min="0.00" value="0.00" step="0.01" style="height: 20px;" ></td>'+
                    '<td>'+
