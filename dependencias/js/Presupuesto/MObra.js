        ...
        $("#delete").on("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        data: {"operario":mobra,"branch":branch},
...
function addMat(nombre,origen,costo,ventana,data,unidad = 0)
{
    var fila = '<tr>'+
                    ...
                    '<td><input type="number" name="cantidadObra[]" onchange="ImporteObra(this);" class="form-control form-control-sm no-bg input-form border-dark text-center totalHora" min="0.00" value="0.00" step="0.01" style="height: 20px;" ></td>'+
                    '<td>'+
