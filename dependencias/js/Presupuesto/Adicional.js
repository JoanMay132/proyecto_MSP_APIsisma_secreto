...
function CambioSucursal(data)
{
    ...
    location.href = "adicionales?suc="+sucursal;
}
        ...
        $("#delete").on("click", function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        data: {"adicional":mat,"branch" : branch},
...
function addMat(nombre,origen,costo,ventana,data,unidad = 0)
{
    var fila = '<tr>'+
                    ...
                    '<td><input type="number" name="cantidadAdicional[]" onchange="ImporteAdicional(this);" class="form-control form-control-sm no-bg input-form border-dark text-center" min="0.00" value="0.00" step="0.01" style="height: 20px;" ></td>'+
                    '<td>'+
