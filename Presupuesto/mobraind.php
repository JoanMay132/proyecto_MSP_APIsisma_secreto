                    ...
                    <?php
                        foreach($oMobra->GetDataAll($suc) as $obra){ ?>
                                <tr ondblclick='addMObra(<?php echo $budget; ?>)' id="rowReg-<?php echo $obra['pkoperario']; ?>" onclick="menu(this);">
                                    ...
                                    <td><input type="text" name="descripcionReg[]" class="form-control" value="<?php echo $obra['descripcion']; ?>"></td>
...
<?php } ?>
 ...
 <?php
    ...
    ?>
 <script type="text/javascript" src="../dependencias/js/Presupuesto/MObraind.js?v=0.0.0"></script>
