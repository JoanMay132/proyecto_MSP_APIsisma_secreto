<?php @session_start();
                    ...
                    <?php
                        foreach($oAdicional->GetDataAll($suc) as $adicional){ ?>
                                ...
                                <?php if($budget) { ?>
                                    ...
                                    <td><input type="text" name="adicionalReg[]" class="form-control" value="<?php echo htmlspecialchars($adicional['nombre'],ENT_QUOTES, 'UTF-8'); ?>"></td>
 ...
 <?php
    ...
    ?>
 <script type="text/javascript" src="../dependencias/js/Presupuesto/Adicional.js"></script>
