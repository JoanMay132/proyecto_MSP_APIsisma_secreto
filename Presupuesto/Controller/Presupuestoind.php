...
include_once "../../controlador/PresupuestoInd.php";
include_once "../../controlador/PrematerialInd.php";
include_once "../../controlador/PremobraInd.php";
include_once "../../controlador/PremaquinariaInd.php";
include_once "../../controlador/PreservicioInd.php";
include_once "../../controlador/Formulas.php";
...
$datos = array(
    ...
    "fksucursal" =>$suc,
    "fkservcot" =>(int) base64_decode($_POST['servicio']),
    "fkcotizacion" =>(int) base64_decode($_POST['cotizacion'])
);
