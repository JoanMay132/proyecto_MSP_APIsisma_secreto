<?php @session_start(); {$title = '- ANALISIS DE COSTOS INSDUSTRIALES';}
...
$obunidad = new Unidad();
$oSuc  = new Sucursal();
$oPre  = new PresupuestoInd();
$oMaquin = new PremaquinariaInd();
$oMobra = new PremobraInd();
$oMaterial = new PrematerialInd();
$oServ = new PreservicioInd();
$oForm  = new Formulas();
                ...
                <div class="row">
                    <div class="col-sm-12" style="padding:unset;">
                        <table  class="table txt-12 table-sm table-info table-striped table-presupuesto"  >
                            <thead class="text-center" ondblclick="OpenWindows('materialesind?suc=<?php echo base64_encode($sucursal); ?>&budget=true','MATERIALES');">
                        ...
                        <table  class="table txt-12 table-sm table-info table-striped table-presupuesto"  >
                            <thead class="text-center" ondblclick="OpenWindows('mobraind?suc=<?php echo base64_encode($sucursal); ?>&budget=true','MANO DE OBRA');"  >
                                <th width="3%" id="border-dark-b"></th>
                            ...
                            ?>
                                ...
                                <tr class="text-right">
                                    ...
                                    <td><input type="number" class="form-control form-control-sm no-bg text-center border-dark input-form" id="tExtra" min="0" value="<?php echo $resul['textra']; ?>" step="0.01" style="height: 20px;"  onchange="tiempoExtra(); ImporteHtaEq();" name="textra"></td>
                                    <td>
                        ...
                        <table class="table txt-12 table-sm table-info table-striped table-presupuesto">
                            <thead class="text-center">
                                ...
                                <th width="10%" id="border-dark-b"><input type="text" class="form-control form-control-sm no-bg text-center border-dark input-form porcentaje" id="inputHtamenor" name="htamenor" min="0" value="<?php echo $resul['htamenor']; ?>%" step="0.01" style="height: 20px;" onchange="ImporteHtaEq();"></th>
                            ...
                            <thead class="text-center">
                                ...
                                <th width="10%" id="border-dark-b"><input type="text" class="form-control form-control-sm no-bg text-center border-dark input-form porcentaje" id="inputEquipo" min="0" value="<?php echo $resul['segpersonal']; ?>%" step="0.01" style="height: 20px;" onchange="ImporteHtaEq();" name="segpersonal"></th>
                                <th width="10%" id="border-dark-b"><p class="input-form importeTotal <?php echo $viewCosto; ?>" id="totalEquipo">$0.00</p></th>
                            </thead>
                        </table>

                        <table  class="table txt-12 table-sm table-info table-striped table-presupuesto"  >
                            <thead class="text-center" ondblclick="OpenWindows('maquinariaind?suc=<?php echo base64_encode($sucursal); ?>&budget=true','MAQUINARIA');" >
                                <th width="3%" id="border-dark-b"></th>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="cantidadMaquin[]" onchange="ImporteMaquinaria(this);" class="form-control form-control-sm no-bg input-form border-dark text-center" min="0" value="<?php echo $rowMaq['cantidad']; ?>" step="0.01" style="height: 20px;" ></td>
                                <td>
                        ...
                        <table   class="table txt-12 table-sm table-info table-striped table-presupuesto">
                            <thead class="text-center" ondblclick="OpenWindows('adicionalesind?suc=<?php echo base64_encode($sucursal); ?>&budget=true','MAQUINARIA');">
                                <th width="3%" id="border-dark-b"></th>
                            ...
                            <tr>
                                ...
                                <td><input type="number" name="cantidadAdicional[]" onchange="ImporteAdicional(this);" class="form-control form-control-sm no-bg input-form border-dark text-center" min="0" value="<?php echo $rowAd['cantidad']; ?>" step="0.01" style="height: 20px;" ></td>
                                <td>
...
<script type="text/javascript" src="../dependencias/js/Presupuesto/Analisisind.js?v=0.0.0"></script>
