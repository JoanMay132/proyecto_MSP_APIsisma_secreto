<?php @session_start(); {$title = '- LISTA PREDEFINIDOS';} //TITULO DE LA PAGINA
    ...
    <main class="main users chart-page" id="skip-target" style="padding:15px;margin-left:0;margin-right:0">
        ...
        <div class="row" style="margin-top:-10px;">
            ...
            <div class="form-group col-12 col-sm-2 text-center" style="padding:2px;margin-top:-10px">
                ...
                <input type="text" id="idescripcion" onkeyup="filtro(this,'f-descripcion');" class="form-control form-control-sm txt-12 text-center" style="height:25px;margin-top:-10px;font-size:11px">
            </div>
            <div class="form-group col-12 col-sm-2 text-center" style="padding:2px;margin-top:-10px">
            ...
            <div class="form-group col-12 col-sm-1">
              <?php if($modifica){ ?>
                <a href="javascript:Presupuesto('predefinido',true)" class="btn btn-primary btn-sm" style="border-radius:0px;"><i class="fa fa-plus fa-lg"></i> Nuevo</a>
                <?php } ?>
            </div>
                ...
                <div style="overflow:auto;height: 83vh;margin-bottom:-58px;background:white" id="display-listpresupuesto">
                    ...
                    <table class="table-stripped table-hover display-table"  width="100%" id="table" style="font-family:'Calibri';background-color: white;font-size:13px;user-select: none;border-collapse: collapse;table-layout: fixed;">
                        ...
                        <tbody class="text-secondary body-table" id="presupuesto">
                          ...
                          <tr style="font-family:'Calibri';font-size:13px;color:#1C1C1C;" onclick="return sel(this);" ondblclick="javascript:Presupuesto('epredefinido?edit=<?php echo base64_encode($result['pkpresupuesto']); ?>')" >
...
function Presupuesto(URL,nuevo = false)
{
    ...
    window[name] ? window[name].focus() : window.open(URL+suc, "PREDEFINIDO", `width=${width},height=${height},scrollbars=yes,left=200,addressbar=0,menubar=0,toolbar=0}`);
...
document.getElementById('sucursalView').addEventListener("click",(event)=>{
  ...
  document.getElementById('sucursalView').addEventListener("click",(event)=>{
    ...
    location.href = "listpredefinidos?suc="+sucursal;
  });
