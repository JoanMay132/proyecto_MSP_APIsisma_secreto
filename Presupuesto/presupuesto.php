...
<style>
  ...
  <div class="main-wrapper">
    ...
    <form id="form-presupuesto" onsubmit="return addPresupuesto();">
       <input type="hidden" name="sub" value="<?php echo @$_GET['sub']; ?>">
        <div class="row">
            ...
            <div class="col-12 col-sm-4">
                <div class="row" style="padding:5px">
                    <table style="width:100%;"  >
                        ...
                        <tr>
                            ...
                            <td colspan="2"><a href="javascript:Presupuesto('cargapredefinido?suc=<?php echo $cargaSuc; ?>','cargapredefinido')"  class="btn btn-info btn-sm"><i class="fa fa-refresh"></i> Carga Predefinidos</a></td>
                        ...
                        <tr>
                            ...
                            <td colspan="2"><a href="javascript:Presupuesto('cargapresupuesto?suc=<?php echo $cargaSuc; ?>','cargapresupuesto')" class="btn btn-sm btn-warning"><i class="fa fa-refresh"></i>Carga presupuestos</a></td>
                ...
                <div class="row">
                    <div class="col-5"><button class="btn btn-outline-info btn-sm" id="btnPrint"><span class="fa fa-print" style="font-size:18px"></span><br>IMPRIMIR Y GUARDAR</button></div>
