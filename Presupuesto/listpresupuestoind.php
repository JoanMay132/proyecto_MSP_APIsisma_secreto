<?php @session_start(); {$title = '- PRESUPUESTO INDUSTRIAL';} //TITULO DE LA PAGINA
  include '../dependencias/php/head.php';
  include '../controlador/Sucursal.php';
  include '../controlador/PresupuestoInd.php';
    ...
    <main class="main users chart-page" id="skip-target" style="padding:15px;margin-left:0;margin-right:0">
        ...
        <div class="row" style="margin-top:-10px;">
            ...
            <div class="form-group col-12 col-sm-2 text-center" style="padding:2px;margin-top:-10px">
                ...
                <select id="sucursalView" onchange="return selecciona();" class="form-control txt-12 text-center" style="height:25px;margin-top:-10px;font-size:11px;padding:0px">
            ...
            <div class="form-group col-12 col-sm-1">
              <?php if($modifica){ ?>
                <a href="javascript:Presupuesto('presupuestoind',true)" class="btn btn-primary btn-sm" style="border-radius:0px;"><i class="fa fa-plus fa-lg"></i> Nuevo</a>
                <?php } ?>
            </div>
            <!-- <div class="form-group col-12 col-sm-1">
            ...
            <div class="col-12">
                <div style="overflow:auto;height: 83vh;margin-bottom:-58px;background:white" id="display-listpresupuesto">
                    ...
                    <table class="table-stripped table-hover display-table"  width="100%" id="table" style="font-family:'Calibri';background-color: white;font-size:13px;user-select: none;border-collapse: collapse;table-layout: fixed;">
                        <thead style="background:beige;position: sticky;top:0;z-index: 10;" >
                        ...
                        <tbody class="text-secondary body-table" id="presupuesto">
                          ...
                          <tr style="font-family:'Calibri';font-size:13px;color:#1C1C1C" onclick="return sel(this);" ondblclick="javascript:Presupuesto('epresupuestoind?edit=<?php echo base64_encode($result['pkpresupuesto']); ?>')" >
...
function Presupuesto(URL,nuevo = false)
{
    ...
    window[name] ? window[name].focus() : window.open(URL+suc, "PRESUPUESTOIND", `width=${width},height=${height},scrollbars=yes,left=200,addressbar=0,menubar=0,toolbar=0}`);
...
function selecciona(){
  ...
  let anio = document.getElementById('anio').value;
    ...
    location.href = "listpresupuestoind?suc="+suc+"&anio="+anio;
}
