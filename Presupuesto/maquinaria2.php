<?php @session_start(); $title = '- MAQUINARIA';
                    ...
                    <?php
                        foreach($oMaquinaria->GetDataAll($suc) as $maquinaria){ ?>
                                ...
                                <?php if($budget) { ?>
                                    ...
                                    <td><input type="text" name="maquinariaReg[]" class="form-control" value="<?php echo htmlspecialchars($maquinaria['nombre'], ENT_QUOTES, 'UTF-8'); ?>"></td>
...
<?php } ?>
 <?php
    ...
    ?>
 <script type="text/javascript" src="../dependencias/js/Presupuesto/Maquinaria.js"></script>
