                 ...
                 <tbody class="body-table table-materiales" >
                    <?php 
                        foreach($oMaterial->GetDataAll($suc) as $material){ ?>
                                <tr ondblclick='addMaterial(<?php echo json_encode($data).",".$budget; ?>)' id="rowReg-<?php echo $material['pkmaterial']; ?>" onclick="menu(this);">
                     ...
                     <tr ondblclick='addMaterial(<?php echo json_encode($data).",".$budget; ?>)' id="row-0" onclick="menu(this);">
                         <?php if($budget) { ?>
