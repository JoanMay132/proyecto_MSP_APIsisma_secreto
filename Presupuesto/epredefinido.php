<?php @session_start(); {$title = '- ANALISIS PREDEFINIDO';}
...
<style>
  ...
  <div class="main-wrapper">
    ...
    <form id="form-presupuesto" onsubmit="return addPredefinido('<?php echo $_GET['edit']; ?>');">
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12" style="padding:unset;">
                        <table  class="table txt-12 table-sm table-success table-striped table-presupuesto"  >
                            ...
                            <tr> 
                                <td><?php if($modifica){ ?><button type="button" onclick="return deleteServPredefinido(this,'<?php echo base64_encode($rowMaterial['pkprematerial2']); ?>','materiales');" class="btn btn-sm btn-outline-danger" style="height:20px;padding-top:0px"><span class="fa fa-trash" style="margin-top:-20px"></span></button><?php }?></td>
                                <input type="hidden" name="prematerial[]" value="<?php echo base64_encode($rowMaterial['pkprematerial2']); ?>">
                        ...
                        <table  class="table txt-12 table-sm table-success table-striped table-presupuesto"  >
                            ...
                            <tr>
                                ...
                                foreach($oMobra->GetDataAll($resul['pkpresupuesto']) as $rowMO){ 
                                    ...
                                    ?>
                                <td><?php if($modifica){ ?><button type="button" onclick="return deleteServPredefinido(this,'<?php echo base64_encode($rowMO['pkpremobra2']); ?>','manoobra');" class="btn btn-sm btn-outline-danger" style="height:20px;padding-top:0px"><span class="fa fa-trash" style="margin-top:-20px"></span></button><?php } ?></td>
                                <input type="hidden" name="premobra[]" value="<?php echo base64_encode($rowMO['pkpremobra2']); ?>">
                            ...
                            ?>
                                <tr id="row-totalHora">
                                    ...
                                    <td>
                                        <input type="number" readonly class="form-control form-control-sm no-bg text-center border-dark input-form" id="canthora"  min="0.00" value="<?php echo $totalHra; ?>" step="0.01" style="height: 20px;">
                                    </td>
                                ...
                                <tr class="text-right">
                                    ...
                                    <td><input type="number" class="form-control form-control-sm no-bg text-center border-dark input-form" id="tExtra" min="0" value="<?php echo $resul['textra']; ?>" step="0.1" style="height: 20px;"  onchange="tiempoExtra(); ImporteHtaEq();" name="textra"></td>
                                    <td>
                                    ...
                                    <td><input type="text" class="form-control form-control-sm no-bg text-center border-dark input-form" id="costoExtra" min="0" value="$<?php echo $resul['costoextra']; ?>" onchange="moneda(this); tiempoExtra(); ImporteHtaEq();" step="0.1" style="height: 20px;" name="costoextra"></td>
                        ...
                        <table  class="table txt-12 table-sm table-success table-striped table-presupuesto"  >
                            ...
                            <tbody>
                                ...
                                foreach($oMaquin->GetDataAll($resul['pkpresupuesto']) as $rowMaq){
                                    ...
                                    ?>
                            <tr>
                                <td><?php if($modifica){ ?><button type="button" onclick="return deleteServPredefinido(this,'<?php echo base64_encode($rowMaq['pkpremaquinaria2']); ?>','maquinaria');" class="btn btn-sm btn-outline-danger" style="height:20px;padding-top:0px"><span class="fa fa-trash" style="margin-top:-20px"></span></button><?php } ?></td>
                                <input type="hidden" name="premaquinaria[]" value="<?php echo base64_encode($rowMaq['pkpremaquinaria2']); ?>">
                        ...
                        <table   class="table txt-12 table-sm table-success table-striped table-presupuesto">
                            ...
                            <tbody>
                                ...
                                foreach($oServ->GetDataAll($resul['pkpresupuesto']) as $rowAd){ 
                                    ...
                                    ?>
                            <tr>
                                <input type="hidden" name="preservicio[]" value="<?php echo base64_encode($rowAd['pkpreservicio2']); ?>">
                                <input type="hidden" name="cnAdicional[]" class="cnacional" value="<?php echo $rowAd['contenido']; ?>">
                                <td><?php if($modifica){ ?><button type="button" onclick="return deleteServPredefinido(this,'<?php echo base64_encode($rowAd['pkpreservicio2']); ?>','servicios');" class="btn btn-sm btn-outline-danger" style="height:20px;padding-top:0px"><span class="fa fa-trash" style="margin-top:-20px"></span></button><?php } ?></td>
            ...
            <div class="col-12 col-sm-4">
                <div class="row" style="padding:5px">
                    <table style="width:100%;"  >
                        ...
                        <tr>
                            ...
                            <td><select class=" form-control-sm input-form" style="width: 120px" id="listCotizacion" onchange="dataCotizacion2(this.value);" name="cotizacion">
                ...
                <div class="row">
                    <div class="col-5"><button type="button" id="btnPrint" class="btn btn-outline-info btn-sm"><span class="fa fa-print" style="font-size:18px"></span><br>IMPRIMIR</button></div>
                    <?php if($modifica){ ?>
                    <div class="col-5"><button id="btnSave" class="btn btn-outline-info btn-sm"><span class="fa fa-floppy-o" style="font-size:18px;"></span><br>GUARDAR</button></div>
                    <?php } ?>
                </div>
            </div>
