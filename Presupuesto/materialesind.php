 <?php @session_start(); {$title = '- MATERIALESIND';} //Titulo de la pagina
...
#region Permisos
 ...
 <center><div id="iconoCarga" style="display: none;">
 ...
 <?php }
    ...
    ?>
 <script type="text/javascript" src="../dependencias/js/Presupuesto/Materialesind.js?v=0.0.0"></script>
